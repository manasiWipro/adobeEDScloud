...
## Environments
- Preview: https://main--adobeEDScloud--manasiWipro.aem.page/
- Live: https://main--adobeEDScloud--manasiWipro.aem.live/
...
1. Open the `adobeEDScloud` directory in your favorite IDE and start coding :)
